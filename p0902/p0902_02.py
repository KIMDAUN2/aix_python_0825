...
# count : 문자열안에 해당문자가 몇개 있는지 확인
# find: 문자열안에 해당문자 위치 반환, 없으면 -1
# index : find와 동일, 없으면 에러
# ss= "파이썬 공부!! 열심히 합시다"
# print(ss.count("공부"))    #1
# print(ss.count("파이썬"))  #1
# print(ss.find("공부"))     #4
# print(ss.find("자바"))     # 없을때:-1
# print(ss.index("자바"))    # index는 없을떄 에러



# # aa= "a/b/c/d/e/f/g"
# # aa_list =aa.split("/")
# # print(aa_list)      #['a', 'b', 'c', 'd', 'e', 'f', 'g']
